...
See https://github.com/daubit/goth/blob/master/examples/main.go to see this in action.
*/
package gothic
...
See https://github.com/daubit/goth/examples/main.go to see this in action.
*/
